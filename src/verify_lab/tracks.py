...
TRACKS: Final = (
    ...
    # 중간선거 해 4분기 ~ 다음해 2분기를 통으로 드는 매매법. **재 보는 중이라 검증 등급**이며,
    # 이 저장소에서 그 등급을 쓰는 첫 매매법이다 — 앞의 셋은 매매나 조사로 이미 갈렸다.
    # 보유가 9개월이라 다른 매매법(며칠~2주)과 성질이 다르다
    Track("midterm_cycle", "중간선거_사이클", GRADE_STUDY, KIND_METHOD),
