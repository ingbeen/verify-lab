...
이상치 날짜는 G0 실측으로 확인된 것이고 근거는 `docs/spec/원달러_그리드_설계.md` §3.3 에 있다.
"""
...
#
# **실측으로 확정한 값이다** (`docs/spec/원달러_그리드_설계.md` §3.4). 보정하지 않으면 261240 일간수익률과의
...
# **NAV 는 정상이고 종가만 튀었다**(`docs/spec/원달러_그리드_설계.md` §3.3).
