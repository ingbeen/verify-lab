...
파라미터 값은 `docs/spec/월말_진입_설계.md` 가 확정한 것이며, **성과를 보며 돌리는 노브가 아니다.**
...
# ============================================================
# 검증 대상 (`docs/spec/월말_진입_설계.md` §3.4)
# ============================================================
...
# 이미 들어 있어 따로 뺄 것이 없다. 근거는 `docs/spec/월말_진입_설계.md` §7.9 다
...
#
# **두 시장을 나눠 둔 것은 시장 하나만 돌려 보기 위해서다.** 전에는 「매매가 코스닥만 돈다」가
# 그 이유였는데 2026-09-12 에 매매도 8대상이 되어 사라졌다 —
# 두 계층 모두 `DATASETS` 를 기본값으로 받는다 (`docs/spec/월말_진입_설계.md` §7.15)
