...
OUTPUT_LABELS: Final = {
    ...
    **{
    ...
    COL_PAYOFF_RATIO: DISPLAY_PAYOFF_RATIO,
    COL_BREAKEVEN_HIT_RATE: DISPLAY_BREAKEVEN_HIT_RATE,
    COL_LOSING_COUNT: DISPLAY_LOSING_COUNT,
...
# 배수로 들어와 자릿수만 맞출 컬럼. **백분율도 확률도 아니다** —
# 2자리로 뭉개면 1.0 경계 근처의 칸을 구별할 수 없다
PAYOFF_OUTPUT_COLUMNS: Final = (COL_PAYOFF_RATIO,)
