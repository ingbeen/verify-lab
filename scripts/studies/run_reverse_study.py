...
인자 없이 실행하면 `docs/spec/역방향_설계.md` 가 확정한 설정으로 돈다.
...
KEY_META_REVERSE_STUDY = "reverse_study"
...
def parse_args() -> argparse.Namespace:
    ...
    Returns:
        파싱된 인자
    """
    parser = argparse.ArgumentParser(description="역방향 검증(역대급 등락 이후 수익률)을 강건성 조합 전체로 실행하고 결과를 저장합니다.")
    parser.add_argument(
        "--dataset",
        nargs="+",
