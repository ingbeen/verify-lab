...
| `option_expiry_study` | `studies/run_option_expiry.py` | 결과 폴더, 검증한 종목, offset 범위·측정 구간, 순열 검정 반복 수·시드, 표별 산출 행 수. `summary.json` 에는 **만기일 요일 분포**와 **매매의 진입·제외 건수·보유 거래일수 분포**도 남는다 |
