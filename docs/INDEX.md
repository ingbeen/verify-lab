...
| [strategy/원달러_그리드.md](strategy/원달러_그리드.md) | **원달러 그리드의 규칙과 성적** — 확정 규칙(§1)·성적(§2)·결정 근거(§3)·한계(§4)·체결 원자료(§5). **아직 운용 대상이 아니며** 채택 여부는 §2.7 의 판정과 §4 의 한계를 보고 정한다 | 원달러 그리드의 규칙이나 성적을 인용·재실행할 때 |
