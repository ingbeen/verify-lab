...
| [strategy/월말_진입_매매_규칙.md](strategy/월말_진입_매매_규칙.md) | **월말 매매의 손절 격자 — 코스피·코스닥 8대상** (2026-09-12 에 4 → 8). 20일 매수 → 말일 매도에 손절선 −3~−10%(1%p 간격)와 무손절을 걸어 12개월 × 두 방향으로 냈다. **−5% 이상이면 후보 달에서 손절이 거의 걸리지 않아 무손절과 성적이 같고**(6·9·12월 0건), **−3%는 반등 구간을 끊어 6월 −8.19%p·12월 −10.77%p 를 깎는다**(§2.1·§3①). 손절이 최악을 **악화시킬 수 있다는 실측**은 §3②. **8대상 매트릭스는 §2.7** — 회당 기대값이 여덟 대상 전부 양수인 달은 **9월과 5월뿐**이고 3·10월은 게이트 0/8 이다. **2000년 이후로 잘라도 12월은 살아나지 않는다**(§2.8, 셋 다 더 약해진다). §1 은 대상 달을 **9·12월**로 좁힌 권고안이며 **4월은 분배락으로 뺐고 5월은 미결**이다. 손절선도 사용자 확정 전이다 | 손절선이나 대상 달을 정하거나 그 근거를 인용할 때. **12개월 전체에서 손절이 무엇을 했는지는 §2.4**, **5월을 왜 미결로 뒀는지는 §1** |
